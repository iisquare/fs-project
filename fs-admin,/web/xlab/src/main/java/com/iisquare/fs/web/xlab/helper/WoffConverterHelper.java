package com.iisquare.fs.web.xlab.helper;
...
public class WoffConverterHelper {
    ...
    public byte[] convertToTTFByteArray(InputStream woffFileStream) throws Exception {
    ...
    public ByteArrayOutputStream convertToTTFOutputStream(InputStream woffFileStream) throws Exception {
    ...
    private void writeFontData(InputStream woffFileStream, ByteArrayOutputStream ttfOutputStream) throws Exception {
        for (HashMap<String, Number> tableRecordEntry : tableRecordEntries) {
