...
(function($){
$(function(){
$(document).unbind(".jmenu").bind("mousedown.jmenu",function(e){
...
item.empty().append($("<div class=\"jmenu-text\"></div>").html(_424.text));
if(_424.iconCls){
$("<div class=\"jmenu-icon\"></div>").addClass(_424.iconCls).appendTo(item);
}
if(_424.id){
...
$(this).find(".jmenu-text").css({height:(opts.itemHeight-2)+"px",lineHeight:(opts.itemHeight-2)+"px"});
});
...
menu.bind(_42f+".jmenu",{target:_42d},opts.events[_42f]);
}
};
function _430(e){
...
item.text=_461.text;
$(_461.target).children("div.jmenu-text").html(_461.text);
});
},setIcon:function(jq,_462){
return jq.each(function(){
var item=$(_462.target).data("menuitem").options;
item.iconCls=_462.iconCls;
$(_462.target).children("div.jmenu-icon").remove();
if(_462.iconCls){
$("<div class=\"jmenu-icon\"></div>").addClass(_462.iconCls).appendTo(_462.target);
}
});
