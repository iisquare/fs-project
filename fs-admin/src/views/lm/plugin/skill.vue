...
<template>
  ...
  <el-card :bordered="false" shadow="never" class="fs-table-card">
    <div class="fs-table-toolbar flex-between">
      <el-space>
        <button-add v-permit="'lm:skill:add'" @click="handleAdd" />
    ...
    >
      ...
      <TableColumn :columns="columns">
        <template #name="scope">
          <el-link type="primary" underline="never" @click="router.push({ path: '/lm/plugin/skillVersion', query: { skillId: scope.row.id } })">{{ scope.row.name }}</el-link>
        </template>
        <template #role="scope">
