...
<template>
  ...
  <el-drawer v-model="infoVisible" :title="'信息查看 - ' + form.id" size="80%">
    <el-descriptions border label-width="100px">
      <el-descriptions-item label="文档名称" :span="3">{{ form.documentInfo?.name }}</el-descriptions-item>
      ...
      <el-descriptions-item label="分段内容" :span="3" class-name="multiline-text">{{ form.content }}</el-descriptions-item>
    </el-descriptions>
  </el-drawer>
