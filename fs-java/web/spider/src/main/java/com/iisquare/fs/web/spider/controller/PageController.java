...
import com.iisquare.fs.web.spider.service.PageService;
...
public class PageController extends PermitControllerBase {
    ...
    public String listAction(@RequestBody Map<String, Object> param) {
        ObjectNode result = pageService.search(param, DPUtil.buildMap("withUserInfo", true, "withStatusText", true));
    ...
    public String saveAction(@RequestBody Map<?, ?> param, HttpServletRequest request) {
        Map<String, Object> result = pageService.save(param, request);
    ...
    public String deleteAction(@RequestBody Map<?, ?> param) {
        ...
        boolean result = pageService.remove(ids);
