package com.iisquare.fs.web.agent.ai;
...
public class MethodToolCallback implements ToolCallback {
    ...
    public static final class Builder {
        ...
        public MethodToolCallback.Builder toolDefinition(ToolDefinition toolDefinition) {
            this.toolDefinition = toolDefinition;
            return this;
        }

        public MethodToolCallback.Builder toolMetadata(ToolMetadata toolMetadata) {
            this.toolMetadata = toolMetadata;
            return this;
        }

        public MethodToolCallback.Builder toolMethod(Method toolMethod) {
            this.toolMethod = toolMethod;
            return this;
        }

        public MethodToolCallback.Builder toolObject(Object toolObject) {
            this.toolObject = toolObject;
            return this;
        }

        public MethodToolCallback.Builder toolCallResultConverter(ToolCallResultConverter toolCallResultConverter) {
