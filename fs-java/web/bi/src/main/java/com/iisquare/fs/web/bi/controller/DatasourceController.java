...
import com.iisquare.fs.web.bi.service.DatasourceService;
...
public class DatasourceController extends PermitControllerBase {
    ...
    public String listAction(@RequestBody Map<String, Object> param) {
        ObjectNode result = datasourceService.search(param,
    ...
    public String saveAction(@RequestBody Map<?, ?> param, HttpServletRequest request) {
        Map<String, Object> result = datasourceService.save(param, request);
    ...
    public String deleteAction(@RequestBody Map<?, ?> param, HttpServletRequest request) {
        ...
        boolean result = datasourceService.remove(ids);
