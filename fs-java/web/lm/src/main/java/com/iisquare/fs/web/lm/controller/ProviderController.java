...
import com.iisquare.fs.web.lm.service.ProviderService;
...
public class ProviderController extends PermitControllerBase {
    ...
    public String saveAction(@RequestBody Map<?, ?> param, HttpServletRequest request) {
        Map<String, Object> result = providerService.save(param, request);
    ...
    public String deleteAction(@RequestBody Map<?, ?> param, HttpServletRequest request) {
        ...
        boolean result = providerService.remove(ids);
