...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '62aa6980-af0e-11f0-bf53-c2f7353079da:1-62921';

--
-- Table structure for table `fs_lucene_dictionary`
--
...
CREATE TABLE `fs_lucene_dictionary` (
  ...
  KEY `idx_catalogue` (`catalogue`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=28317 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
-- Dump completed on 2026-08-25  8:44:27
