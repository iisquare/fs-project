...
import com.iisquare.fs.web.admin.service.FlowNodeService;
...
public class FlowNodeController extends PermitController {
    ...
    public String saveAction(@RequestBody Map<?, ?> param, HttpServletRequest request) {
        ...
        info = flowNodeService.save(info, uid(request));
    ...
    public String deleteAction(@RequestBody Map<?, ?> param, HttpServletRequest request) {
        ...
        boolean result = flowNodeService.delete(ids, uid(request));
