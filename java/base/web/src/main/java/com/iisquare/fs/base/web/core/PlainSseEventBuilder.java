package com.iisquare.fs.base.web.core;
...
public class PlainSseEventBuilder implements SseEmitter.SseEventBuilder {
    ...
    PlainSseEventBuilder append(String text) {
        if (this.sb == null) {
    ...
    public PlainSseEventBuilder line(String line) {
        append(line).append("\n");
        return this;
    }
