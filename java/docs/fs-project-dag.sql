...
Date: 2021-03-24 08:15:37
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for fs_dag_flow
-- ----------------------------
DROP TABLE IF EXISTS `fs_dag_flow`;
CREATE TABLE `fs_dag_flow` (
...
-- ----------------------------
-- Table structure for fs_dag_node
-- ----------------------------
DROP TABLE IF EXISTS `fs_dag_node`;
CREATE TABLE `fs_dag_node` (
...
-- ----------------------------
-- Table structure for fs_dag_plugin
-- ----------------------------
DROP TABLE IF EXISTS `fs_dag_plugin`;
CREATE TABLE `fs_dag_plugin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(32) NOT NULL DEFAULT '',
