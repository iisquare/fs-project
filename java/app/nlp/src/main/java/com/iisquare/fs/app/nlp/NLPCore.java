...
public class NLPCore {
    ...
    public static final String SQL_POLICY = "select base_id, title, content from dwd_policy_info where classify_primary='D4F6C59F-2C9F-4A7E-8F57-1BD696F5C010' and doc_no!=''";
