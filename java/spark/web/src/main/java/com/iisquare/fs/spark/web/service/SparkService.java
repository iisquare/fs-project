...
@Service
public class SparkService extends ServiceBase {

    @Value("${fs.spark.k8sUrl}")
    private String k8sUrl;
    @Value("${fs.spark.kvConfigUrl}")
    private String kvConfigUrl;
    @Value("${fs.spark.kvConfigType:json}")
    private String kvConfigType;
    @Value("${fs.spark.plugins.dir}")
    private String pluginsDir;
    @Value("${fs.spark.plugins.url}")
