<template>
  <section>
    ...
    <a-row class="form-row">
      <a-col :md="24" :sm="24">
        <a-form-model-item label="公式语句">
          <a-textarea v-model="value.content.expression" placeholder="SQL判断表达式" />
        </a-form-model-item>
      </a-col>
    </a-row>
    <a-row class="form-row">
...
export default {
  ...
  methods: {
    formatted (obj) {
      const options = {
        expression: obj.content.expression ?? this.defaults.expression
      }
