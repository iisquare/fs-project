  ...
  <a-tabs default-active-key="property" :animated="false">
    <a-tab-pane key="property" tab="属性">
      <a-form-model :model="value" labelAlign="left" :label-col="{ span: 6 }" :wrapper-col="{ span: 18 }">
        ...
        <a-form-model-item label="文件路径"><a-textarea v-model="value.options.jarURI" placeholder="JAR文件的网络路径" /></a-form-model-item>
        <a-form-model-item label="规则类名"><a-textarea v-model="value.options.pkgClass" placeholder="规则所在的类文件路径" /></a-form-model-item>
      </a-form-model>
    </a-tab-pane>
  </a-tabs>
</template>
...
export default {
  ...
  methods: {
    formatted (obj) {
      const options = {
        jarURI: obj.options.jarURI || this.defaults.jarURI,
        pkgClass: obj.options.pkgClass || this.defaults.pkgClass
      }
