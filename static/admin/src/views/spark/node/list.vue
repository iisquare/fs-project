      ...
      <div class="table-page-search-wrapper">
        ...
        >
          ...
          <span slot="action" slot-scope="text, record">
            <a-button-group>
              <a-button type="link" size="small" v-permit="'spark:node:'" @click="show(text, record)">查看</a-button>
              <a-button v-permit="'spark:node:modify'" type="link" size="small" @click="edit(text, record)">编辑</a-button>
              <a-button v-permit="'spark:node:modify'" type="link" size="small" @click="sublevel(text, record)">子级</a-button>
            </a-button-group>
          </span>
        </a-table>
