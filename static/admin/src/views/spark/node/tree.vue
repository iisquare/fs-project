  ...
  <section>
    <a-card :bordered="false">
      <template slot="title">
        ...
        <a-divider type="vertical" v-permit="'spark:node:delete'" />
        <a-button icon="minus-circle" type="danger" @click="batchRemove" v-permit="'spark:node:delete'" :disabled="selection.selectedRows.length === 0">删除</a-button>
        <a-divider type="vertical" v-permit="'spark:node:add'" />
        <a-button icon="plus-circle" type="primary" @click="add(0)" v-permit="'spark:node:add'">新增</a-button>
      </template>
      <div class="table-page-search-wrapper">
        ...
        >
          ...
          <span slot="action" slot-scope="text, record">
            <a-dropdown>
              <a-menu slot="overlay">
                <a-menu-item v-permit="'spark:node:'"><a-button :block="true" type="link" size="small" @click="show(text, record)">查看</a-button></a-menu-item>
                <a-menu-item v-permit="'spark:node:modify'"><a-button :block="true" type="link" size="small" @click="edit(text, record)">编辑</a-button></a-menu-item>
                <a-menu-item v-permit="'spark:node:add'"><a-button :block="true" type="link" size="small" @click="sublevel(text, record)">子级</a-button></a-menu-item>
              </a-menu>
...
import nodeService from '@/service/spark/node'
