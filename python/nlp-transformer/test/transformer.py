...
"""
文件说明：
- [Transformer简版实战教程](https://blog.csdn.net/weixin_42486623/article/details/122088533)
- [Transformer代码(源码Pytorch版本)从零解读(Pytorch版本）](https://www.bilibili.com/video/BV1dR4y1E7aL/)
- [graykode/nlp-tutorial](https://github.com/graykode/nlp-tutorial/blob/master/5-1.Transformer/Transformer.ipynb)
"""
